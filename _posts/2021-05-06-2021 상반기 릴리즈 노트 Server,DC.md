...
<p data-renderer-start-pos="157"><h3><strong data-renderer-mark="true">■ Version 8.15</h3></strong></p>

<h4 id="1.-Advanced-RoadMap-기능-추가-DATA-CENTER" data-renderer-start-pos="173">1. Advanced RoadMap 기능 추가 (Data Center) </h4>
...
<h4 id="2.-이메일-알림에-이미지-첨부-표시-SERVER-DATA-CENTER" data-renderer-start-pos="368">2. 이메일 알림에 이미지 첨부 표시 (Server, Data Center)</h4>
...
<p data-renderer-start-pos="532"><strong data-renderer-mark="true"><h3>■ Version 8.16</h3></strong></p>


<h4 id="1.-Custom-Field-개선-DATA-CENTER" data-renderer-start-pos="548">1. Custom Field 개선 (Data Center)</h4>
...
<h4 id="2.-Description-필드의-기본값-설정-DATA-CENTER" data-renderer-start-pos="925">2. Description 필드의 기본값 설정 (Data Center) </h4>
...
<h4 id="3.-DVCS-관리-SERVER-DATA-CENTER" data-renderer-start-pos="1114">3. DVCS 관리 (Server, Data Center)</h4>
...
<h4 id="4.-사용자가-여러-ID-공급자로-로그인하도록-허용-DATA-CENTER" data-renderer-start-pos="1281">4. 사용자가 여러 ID 공급자로 로그인하도록 허용 (Data Center) </h4>
...
<h4 id="5.-Data-Pipeline-내보내기-상태-확인-기능-DATA-CENTER" data-renderer-start-pos="1464"><strong data-renderer-mark="true">5</strong>. Data Pipeline 내보내기 상태 확인 기능 (Data Center) </h4>
...
<h3 id="해결된-이슈-사항" data-renderer-start-pos="1624"><em data-renderer-mark="true"><strong data-renderer-mark="true">해결된 이슈 사항</strong></em></h3>



<p data-renderer-start-pos="1637"><strong data-renderer-mark="true"><h4>■ Version 8.15</strong><h4></p>
...
<p data-renderer-start-pos="2241"><h4><strong data-renderer-mark="true">■ Version 8.16</strong></h4></p>
...
<h2 id="2.-Jira-Service-Management" data-renderer-start-pos="2640"><em data-renderer-mark="true"><strong data-renderer-mark="true">2. Jira Service Management</strong></em>  </h2>



<p data-renderer-start-pos="2670"><h3>■ Version 4.15</h3></p>



<h4 id="1.-Mindville-Insight-어플리케이션이-Jira-Service-Management에-추가-DATA-CENTER" data-renderer-start-pos="2686">1. Mindville Insight 어플리케이션이 Jira Service Management에 추가 (Data Center) </h4>
...
<h4 id="2.-고객-포털-개선-SERVER--DATA-CENTER" data-renderer-start-pos="3083">2. 고객 포털 개선 (Data Center) </h4>
...
<h4 id="3.-향상된-데이터-인사이트를-Jira-Service-Management에서-활용--DATA-CENTER" data-renderer-start-pos="3609">3. 향상된 데이터 인사이트를 Jira Service Management에서 활용  (Data Center) </h4>
...
<h4 id="4.-이메일-알림에-이미지-첨부-표시-SERVER-DATA-CENTER" data-renderer-start-pos="4051">4. 이메일 알림에 이미지 첨부 표시 (Server , Data Center)</h4>
...
<h3 id="해결된-이슈-사항.1" data-renderer-start-pos="4235"><em data-renderer-mark="true"><strong data-renderer-mark="true">해결된 이슈 사항</strong></em></h3>



<p data-renderer-start-pos="4248"><h4><strong data-renderer-mark="true">■ Version 4.15</strong></h4></p>
...
<p data-renderer-start-pos="4705"><h4><strong data-renderer-mark="true">■ Version 4.16</strong></h4></p>
...
<p data-renderer-start-pos="5174"><h3>■ Version 7.11</h3></p>



<h4 id="1.-Analytics-기능이-Confluence에-추가-DATA-CENTER" data-renderer-start-pos="5190">1. Analytics 기능이 Confluence에 추가 (Data Center) </h4>
...
<p data-renderer-start-pos="5313"><h5>1. 전체적인 Insight 확인</h5></p>
...
<p data-renderer-start-pos="5424"><h5>  2.  스페이스 또는 페이지 분석 시 보기 기능 뿐만 아닌 그 이상의 기능 추가</h5></p>
...
<p data-renderer-start-pos="5635"><h5> 3. 개인 정보 보호를 염두에 두고 구축</h5></p>
...
<h4 id="2.-Confluence에-Team-Calendar-앱-추가-DATA-CENTER" data-renderer-start-pos="5958">2. Confluence에 Team Calendar 앱 추가 (Data Center)</h4>
...
<h4 id="3.-TroubleShooting-개선--SERVER-DATA-CENTER" data-renderer-start-pos="6162">3. TroubleShooting 개선 (Server, DataCenter)</h4>
...
<p data-renderer-start-pos="6194"><h5>  1. Troubleshooting 시 로그 표시</h5></p>
...
<p data-renderer-start-pos="6383"><h5>  2. 보다 더 명확하게 하기 위한 전용 로그 파일 제공</h5></p>
...
<p data-renderer-start-pos="6837"><h5> 3. Access logging 기본 설정 (Server , Data Center) </h5> </p>
...
액세스 로그는 30일 동안 보관되고  <install-directory>/logs 디렉토리에 있으며 요구 사항에 맞게 구성 할 수 있습니다.
 ...
 <p data-renderer-start-pos="7202"><h3>■ Version 7.12</h3></p>
 
 
 
 <p data-renderer-start-pos="7218"><h4>  1. 사이트에 대한 데이터 및 인사이트 확보 가능 (Data Center)</h4> </p>
 ...
 <p data-renderer-start-pos="7519"><h4>  2. Thread Dump 에 진단 정보 추가 (Server, Data Center) </h4> </p>
 ...
 <h3 id="해결된-이슈-사항.2" data-renderer-start-pos="7853"><em data-renderer-mark="true"><strong data-renderer-mark="true">해결된 이슈 사항</strong></em></h3>
 
 
 
 
 <p data-renderer-start-pos="7866"><h4>■ Version 7.11</h4></p>
 ...
 <p data-renderer-start-pos="8604"><h4>■ Version 7.12</h4></p>
