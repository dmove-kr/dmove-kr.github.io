---
layout: post
title: 2021 Atlassian 주요 제품 릴리즈 노트 (July ~ Sep) - Server,DC
...
이를 쉽게 하기 위해 Data Pipeline 관리 화면에서 **스케쥴 내보내기**을 설정할 수 있습니다. 사용자가 필요에 따라 **주기적** 또는 **비 주기적**으로 내보내도록 선택할 수 있습니다.
...
- **사용자 세부 정보**
  정보 이제 사용자 세부 정보를 단일 파일로 내보낼 수 있습니다. 이렇게 하면 단일 팀 구성원 이름 및 이메일 주소 집합으로 사용자 ID를 더 쉽게 상호 참조할 수 있습니다. 예를 들어 이슈 파일에 사용자의 이름이 포함되지 않게 함으로써 데이터를 익명으로 처리하는 데 사용할 수 있습니다.
- **이슈 링크**
